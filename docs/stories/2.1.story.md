...
- [x] Task 6: Add Service Configuration
  - [x] Create WebSocket configuration class with URL: `wss://facedetection-ws.owt.vn`
...
- **WebSocket URL**: Configurable backend URL (wss://facedetection-ws.owt.vn for development)
