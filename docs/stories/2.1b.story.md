...
- [ ] Verify BLoC integration works correctly
- [ ] Test automatic connection after camera ready
- [ ] Confirm debug logging completeness
- [ ] Validate app lifecycle handling
- [ ] Check retry logic integration

### Change Log
- Split from Story 2.1 for parallel development with Story 2.1a
- Focus on BLoC integration and automatic connection logic 