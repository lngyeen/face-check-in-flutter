...
gantt
    ...
    section [Team Member 1] - Multi-Tool Setup
    [AI Story/Task 1]           :active, tm1s1, 0, 2
    [AI Story/Task 2]           :tm1s2, 2, 4
    [AI Integration Work]       :tm1int, 4, 6
    [AI Story/Task 3]           :tm1s3, 6, 8
    [AI Demo Prep]              :tm1demo, 8, 10
    
    section [Team Member 2] - Optimized Setup
    [AI Story/Task 1]           :active, tm2s1, 0, 2
    [AI Story/Task 2]           :tm2s2, 2, 5
    [AI Integration Support]    :tm2int, 5, 7
    [AI Final Testing]          :tm2test, 7, 10
    
    section [Team Member 3] - Standard Setup
    [AI Story/Task 1]           :active, tm3s1, 0, 3
    [AI Story/Task 2]           :tm3s2, 3, 6
    [AI Integration & Polish]   :tm3polish, 6, 10
    
    section AI Integration Milestones
    AI Context Setup            :milestone, ai1, 0, 0d
    Stream A AI Complete        :milestone, m1, 2, 0d
    AI Context Refresh          :crit, ai2, 4, 0d
    Mid-Sprint AI Integration   :crit, m2, 6, 0d
    AI Quality Check            :milestone, ai3, 8, 0d
    AI Demo Ready               :milestone, m4, 10, 0d
```
